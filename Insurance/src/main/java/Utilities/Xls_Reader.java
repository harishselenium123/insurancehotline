...
public class Xls_Reader 
{
	...
	public boolean setCellData(String sheetName,String colName,int rowNum, String data)
	{
	 ...
	 // find whether sheets exists	
	    ...
	    public  int rowCount(String Content) throws Exception{
	    	int iRow=1;
	    	try{
			    	
			    	for (iRow=1;iRow<=9;iRow++){
			    		 sActionKeyword = getCellData(iRow, 1);
			    		if(sActionKeyword.equals(Content)){
			    			break;
			    		}
			    		}
	    	...
	    	throw new RuntimeException("Given WebService Method not Matching");
